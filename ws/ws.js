...
class WebSocket {
    ...
    backendHandler() {
        ...
        this.app.post('/sendMessage', (req, res) => {
            ...
            // making sure all variables/queries are accounted for
            ...
            // getting the channel that was requested at the http page
            ...
            if (chan) {
                // equivalent to message.channel.send() but we already have message.channel in chan
                chan.send(text)
                res.sendStatus(200)
            } else
                res.sendStatus(406)
